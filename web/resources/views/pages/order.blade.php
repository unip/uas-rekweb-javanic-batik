  ...
  <div class="order-page" x-data="{ showModal: false }">
    <section class="kategori mb-[67px]">
            ...
            <div class="pesanan">
              ...
              <div class="flex flex-col gap-3">
                ...
                @foreach($pesanan_terkini as $p)
                  <button type="button" @click="showModal = true" class="item flex gap-3 bg-white hover:bg-gray-50 p-5 transition duration-200">
                    <dl>
                ...
                @for ($i = 1; $i < 4; $i++)
                  <button type="button" @click="showModal = true" class="item flex gap-3 bg-white hover:bg-gray-50 p-5 transition duration-200 *:flex *:flex-col x:items-start">
                    <dl>
                      <dt class="text-xs text-gray-400">No. Order</dt>
      ...
      >
          <!-- Modal inner -->
          <div
              class="max-w-3xl px-4 py-4 mx-auto text-left bg-white shadow-lg"
          ...
          >
              ...
              <div class="flex gap-4">
                <img src="{{ asset('/images/kategori/batik-wanita.png') }}" alt="" class="aspect-square">
